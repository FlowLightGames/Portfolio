...
onready var pos =[
$VBoxContainer/HBoxContainer.rect_position+$VBoxContainer.rect_position+Vector2(-4,+6),
$VBoxContainer/HBoxContainer2.rect_position+$VBoxContainer.rect_position+Vector2(-4,+6),
$VBoxContainer/HBoxContainer3.rect_position+$VBoxContainer.rect_position+Vector2(-4,+6),
$VBoxContainer/HBoxContainer4.rect_position+$VBoxContainer.rect_position+Vector2(-4,+6)
]
...
export(int, 5) var BT_V=0
export(int, 31) var BC_V=0
export(int, 21) var FT_V=0
export(int, 31) var FC_V=0

export(int, 7) var player=0
