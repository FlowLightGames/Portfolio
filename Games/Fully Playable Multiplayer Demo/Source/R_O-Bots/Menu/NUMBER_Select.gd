...
onready var pos =[
$CenterContainer/VBoxContainer/HBoxContainer.rect_global_position-Vector2(14,0)
]
...
func check_input():
	if Input.is_action_just_pressed("ui_accept"):
		GLOBALS.change_level("res://Menu/SELECT_Scene.tscn")
	if Input.is_action_just_pressed("ui_cancel"):
		GLOBALS.change_level("res://Menu/MAIN_Menu.tscn")
